...
> A small playground for trying video streaming ideas, asset management, and distributed systems.

The project explores video processing pipelines, DDD boundaries, and event-driven services. 
...
Then open: AKHQ `http://localhost:8086`, Kibana `http://localhost:5601`, CDN `http://localhost:8083/health`.


## Dev helpers

```
make backend-lint, make backend-test, make backend-generate, make backend-build
```
